<template>
    <div class="flex justify-between items-center !h-full 2xl:gap-3 lg:gap-2">
        ...
        <div class=" min-w-[425px] flex justify-between items-center !h-full 2xl:gap-4 xl:gap-2 lg:gap-2 gap-1">
            <div class="">
                <BaseContainer class="">
                    <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="首页"
            ...
            <div class="">
                <BaseContainer class="">
                    <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="番剧"
                        @click="clickTag()">
                    </ButtonLabel>
                </BaseContainer>
            </div>
            <div class="">
                <BaseContainer class="">
                    <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="直播"
                        @click="clickTag()">
                    </ButtonLabel>
                </BaseContainer>
            </div>
            <div class="">
                <BaseContainer class="">
                    <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="游戏中心"
                        @click="clickTag()">
                    </ButtonLabel>
                </BaseContainer>
            </div>
            <div class="">
                <BaseContainer class="">
                    <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="会员购"
                        @click="clickTag()">
                    </ButtonLabel>
                </BaseContainer>
            </div>
            <div class="">
                <BaseContainer class="">
                    <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="漫画"
                        @click="clickTag()">
                    </ButtonLabel>
                </BaseContainer>
            </div>
            <div class="">
                <BaseContainer class="">
                    <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="赛事"
                        @click="clickTag()">
                    </ButtonLabel>
                </BaseContainer>
            </div>
            <div class="">
                <BaseContainer class="">
                    <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="下载客户端"
                        @click="clickTag()">
                    </ButtonLabel>
                    <template #left>
                        <el-icon class="!w-[30px] !">
