    ...
    <div class="w-full !px-[24px] top-0 !h-[64px]">
        <div class="w-full flex justify-between items-center !h-full 2xl:gap-3 lg:gap-2">
            ...
            <div class=" min-w-[425px] flex justify-between items-center !h-full 2xl:gap-4 xl:gap-2 lg:gap-2 gap-1">
                <div class="">
                    <BaseContainer class="">
                        <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="首页" @click="clickTag()">
                        </ButtonLabel>
                        <template #left>
                ...
                <div class="">
                    <BaseContainer class="">
                        <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="番剧" @click="clickTag()">
                        </ButtonLabel>
                    </BaseContainer>
                </div>
                <div class="">
                    <BaseContainer class="">
                        <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="直播" @click="clickTag()">
                        </ButtonLabel>
                    </BaseContainer>
                </div>
                <div class="">
                    <BaseContainer class="">
                        <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="游戏中心" @click="clickTag()">
                        </ButtonLabel>
                    </BaseContainer>
                </div>
                <div class="">
                    <BaseContainer class="">
                        <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="会员购" @click="clickTag()">
                        </ButtonLabel>
                    </BaseContainer>
                </div>
                <div class="">
                    <BaseContainer class="">
                        <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="漫画" @click="clickTag()">
                        </ButtonLabel>
                    </BaseContainer>
                </div>
                <div class="">
                    <BaseContainer class="">
                        <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="赛事" @click="clickTag()">
                        </ButtonLabel>
                    </BaseContainer>
                </div>
                <div class="">
                    <BaseContainer class="">
                        <ButtonLabel class="  text-[14px]" bgColor="" hoverEffect="" text="下载客户端" @click="clickTag()">
                        </ButtonLabel>
                        <template #left>
                            <el-icon class="!w-[30px] !">
            ...
            <div class="flex justify-center items-center !w-[30%] min-w-[350px] px-2">
                <div class="w-full ">
                    <SearchInput v-model="query" @search="onSearch" @dropdown-toggle="onDropdownToggle" class="w-full ">
                        <template #dropdown>
                            <div class="p-2 text-sm  h-[300px]">
            ...
            <div
                ...
                <div class="">
                    <BaseContainer class=" cursor-pointer" @click="clickTag()">
                        <ButtonLabel class="!py-[0px]  text-[14px] !hidden lg:!block " bgColor="" hoverEffect=""
                            text="大会员">
                        </ButtonLabel>
                        <template #top>
                            <el-icon class=" !w-[20px] !h-[20px] ! ">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="!w-[20px] !h-[20px] right-entry-icon">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="">
                    <BaseContainer class=" cursor-pointer" @click="clickTag()">
                        <ButtonLabel class="!py-[0px] !mt-[2px]  text-[14px] !hidden lg:!block " bgColor=""
                            hoverEffect="" text="动态"></ButtonLabel>
                        <template #top>
                            <el-icon class="!w-[30px] !">
                ...
                <div class="">
                    <BaseContainer class=" cursor-pointer" @click="clickTag()">
                        <ButtonLabel class="!py-[0px] !mt-[2px]  text-[14px] !hidden lg:!block " bgColor=""
                            hoverEffect="" text="收藏"></ButtonLabel>
                        <template #top>
                            <el-icon class="!w-[30px] !">
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="!w-[20px] !h-[20px] right-entry-icon">
                ...
                <div class="">
                    <BaseContainer class=" cursor-pointer" @click="clickTag()">
                        <ButtonLabel class="!py-[0px] !mt-[2px]  text-[14px] !hidden lg:!block " bgColor=""
                            hoverEffect="" text="历史"></ButtonLabel>
                        <template #top>
                            <el-icon class="!w-[30px] !">
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="!w-[20px] !h-[20px] right-entry-icon">
                ...
                <div class="">
                    <BaseContainer class=" cursor-pointer" @click="clickTag()">
                        <ButtonLabel class="!py-[0px] !mt-[2px]  text-[14px] !hidden lg:!block " bgColor=""
                            hoverEffect="" text="创作中心"></ButtonLabel>
                        <template #top>
                            <el-icon class="!w-[30px] !">
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="!w-[20px] !h-[20px] right-entry-icon">
...
import MessageOption from './children/messageOption/MessageOption.vue';
